...
pub type R = crate::R<UCA0CTLW1_SPEC>;
#[doc = "Register `UCA0CTLW1` writer"]
pub type W = crate::W<UCA0CTLW1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucglit(&mut self) -> UCGLIT_W<UCA0CTLW1_SPEC> {
        UCGLIT_W::new(self, 0)
    }
...
#[doc = "USCI A0 Control Word Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uca0ctlw1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uca0ctlw1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
