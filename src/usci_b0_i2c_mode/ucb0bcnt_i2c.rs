...
pub type UCBCNT0_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT1_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT2_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT3_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT4_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT5_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT6_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
...
pub type UCBCNT7_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0BCNT_I2C_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - USCI Byte Counter Bit 0"]
    #[inline(always)]
    pub fn ucbcnt0(&mut self) -> UCBCNT0_W<0> {
        UCBCNT0_W::new(self)
    }
    #[doc = "Bit 1 - USCI Byte Counter Bit 1"]
    #[inline(always)]
    pub fn ucbcnt1(&mut self) -> UCBCNT1_W<1> {
        UCBCNT1_W::new(self)
    }
    #[doc = "Bit 2 - USCI Byte Counter Bit 2"]
    #[inline(always)]
    pub fn ucbcnt2(&mut self) -> UCBCNT2_W<2> {
        UCBCNT2_W::new(self)
    }
    #[doc = "Bit 3 - USCI Byte Counter Bit 3"]
    #[inline(always)]
    pub fn ucbcnt3(&mut self) -> UCBCNT3_W<3> {
        UCBCNT3_W::new(self)
    }
    #[doc = "Bit 4 - USCI Byte Counter Bit 4"]
    #[inline(always)]
    pub fn ucbcnt4(&mut self) -> UCBCNT4_W<4> {
        UCBCNT4_W::new(self)
    }
    #[doc = "Bit 5 - USCI Byte Counter Bit 5"]
    #[inline(always)]
    pub fn ucbcnt5(&mut self) -> UCBCNT5_W<5> {
        UCBCNT5_W::new(self)
    }
    #[doc = "Bit 6 - USCI Byte Counter Bit 6"]
    #[inline(always)]
    pub fn ucbcnt6(&mut self) -> UCBCNT6_W<6> {
        UCBCNT6_W::new(self)
    }
    #[doc = "Bit 7 - USCI Byte Counter Bit 7"]
    #[inline(always)]
    pub fn ucbcnt7(&mut self) -> UCBCNT7_W<7> {
        UCBCNT7_W::new(self)
    }
