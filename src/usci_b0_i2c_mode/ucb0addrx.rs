...
pub type UCADDRX0_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX1_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX2_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX3_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX4_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX5_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX6_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX7_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX8_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
...
pub type UCADDRX9_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0ADDRX_SPEC, bool, O>;
impl R {
...
impl W {
    #[doc = "Bit 0 - I2C Receive Address Bit 0"]
    #[inline(always)]
    pub fn ucaddrx0(&mut self) -> UCADDRX0_W<0> {
        UCADDRX0_W::new(self)
    }
    #[doc = "Bit 1 - I2C Receive Address Bit 1"]
    #[inline(always)]
    pub fn ucaddrx1(&mut self) -> UCADDRX1_W<1> {
        UCADDRX1_W::new(self)
    }
    #[doc = "Bit 2 - I2C Receive Address Bit 2"]
    #[inline(always)]
    pub fn ucaddrx2(&mut self) -> UCADDRX2_W<2> {
        UCADDRX2_W::new(self)
    }
    #[doc = "Bit 3 - I2C Receive Address Bit 3"]
    #[inline(always)]
    pub fn ucaddrx3(&mut self) -> UCADDRX3_W<3> {
        UCADDRX3_W::new(self)
    }
    #[doc = "Bit 4 - I2C Receive Address Bit 4"]
    #[inline(always)]
    pub fn ucaddrx4(&mut self) -> UCADDRX4_W<4> {
        UCADDRX4_W::new(self)
    }
    #[doc = "Bit 5 - I2C Receive Address Bit 5"]
    #[inline(always)]
    pub fn ucaddrx5(&mut self) -> UCADDRX5_W<5> {
        UCADDRX5_W::new(self)
    }
    #[doc = "Bit 6 - I2C Receive Address Bit 6"]
    #[inline(always)]
    pub fn ucaddrx6(&mut self) -> UCADDRX6_W<6> {
        UCADDRX6_W::new(self)
    }
    #[doc = "Bit 7 - I2C Receive Address Bit 7"]
    #[inline(always)]
    pub fn ucaddrx7(&mut self) -> UCADDRX7_W<7> {
        UCADDRX7_W::new(self)
    }
    #[doc = "Bit 8 - I2C Receive Address Bit 8"]
    #[inline(always)]
    pub fn ucaddrx8(&mut self) -> UCADDRX8_W<8> {
        UCADDRX8_W::new(self)
    }
    #[doc = "Bit 9 - I2C Receive Address Bit 9"]
    #[inline(always)]
    pub fn ucaddrx9(&mut self) -> UCADDRX9_W<9> {
        UCADDRX9_W::new(self)
    }
