...
pub type UCSWACK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0CTLW1_SPEC, bool, O>;
...
pub type UCETXINT_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCB0CTLW1_SPEC, bool, O>;
impl R {
