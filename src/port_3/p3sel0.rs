...
pub type R = crate::R<P3SEL0_SPEC>;
#[doc = "Register `P3SEL0` writer"]
pub type W = crate::W<P3SEL0_SPEC>;
#[doc = "Field `P3SEL0_0` reader - P3SEL0_0"]
pub type P3SEL0_0_R = crate::BitReader;
#[doc = "Field `P3SEL0_0` writer - P3SEL0_0"]
pub type P3SEL0_0_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_1` reader - P3SEL0_1"]
pub type P3SEL0_1_R = crate::BitReader;
#[doc = "Field `P3SEL0_1` writer - P3SEL0_1"]
pub type P3SEL0_1_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_2` reader - P3SEL0_2"]
pub type P3SEL0_2_R = crate::BitReader;
#[doc = "Field `P3SEL0_2` writer - P3SEL0_2"]
pub type P3SEL0_2_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_3` reader - P3SEL0_3"]
pub type P3SEL0_3_R = crate::BitReader;
#[doc = "Field `P3SEL0_3` writer - P3SEL0_3"]
pub type P3SEL0_3_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_4` reader - P3SEL0_4"]
pub type P3SEL0_4_R = crate::BitReader;
#[doc = "Field `P3SEL0_4` writer - P3SEL0_4"]
pub type P3SEL0_4_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_5` reader - P3SEL0_5"]
pub type P3SEL0_5_R = crate::BitReader;
#[doc = "Field `P3SEL0_5` writer - P3SEL0_5"]
pub type P3SEL0_5_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_6` reader - P3SEL0_6"]
pub type P3SEL0_6_R = crate::BitReader;
#[doc = "Field `P3SEL0_6` writer - P3SEL0_6"]
pub type P3SEL0_6_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `P3SEL0_7` reader - P3SEL0_7"]
pub type P3SEL0_7_R = crate::BitReader;
#[doc = "Field `P3SEL0_7` writer - P3SEL0_7"]
pub type P3SEL0_7_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - P3SEL0_0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_0(&mut self) -> P3SEL0_0_W<P3SEL0_SPEC> {
        P3SEL0_0_W::new(self, 0)
    }
    #[doc = "Bit 1 - P3SEL0_1"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_1(&mut self) -> P3SEL0_1_W<P3SEL0_SPEC> {
        P3SEL0_1_W::new(self, 1)
    }
    #[doc = "Bit 2 - P3SEL0_2"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_2(&mut self) -> P3SEL0_2_W<P3SEL0_SPEC> {
        P3SEL0_2_W::new(self, 2)
    }
    #[doc = "Bit 3 - P3SEL0_3"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_3(&mut self) -> P3SEL0_3_W<P3SEL0_SPEC> {
        P3SEL0_3_W::new(self, 3)
    }
    #[doc = "Bit 4 - P3SEL0_4"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_4(&mut self) -> P3SEL0_4_W<P3SEL0_SPEC> {
        P3SEL0_4_W::new(self, 4)
    }
    #[doc = "Bit 5 - P3SEL0_5"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_5(&mut self) -> P3SEL0_5_W<P3SEL0_SPEC> {
        P3SEL0_5_W::new(self, 5)
    }
    #[doc = "Bit 6 - P3SEL0_6"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_6(&mut self) -> P3SEL0_6_W<P3SEL0_SPEC> {
        P3SEL0_6_W::new(self, 6)
    }
    #[doc = "Bit 7 - P3SEL0_7"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel0_7(&mut self) -> P3SEL0_7_W<P3SEL0_SPEC> {
        P3SEL0_7_W::new(self, 7)
    }
