...
pub type R = crate::R<TA3CCR1_SPEC>;
#[doc = "Register `TA3CCR1` writer"]
pub type W = crate::W<TA3CCR1_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<TA3CCR1_SPEC> {
