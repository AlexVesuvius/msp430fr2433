...
pub type R = crate::R<TA3EX0_SPEC>;
#[doc = "Register `TA3EX0` writer"]
pub type W = crate::W<TA3EX0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn taidex(&mut self) -> TAIDEX_W<TA3EX0_SPEC> {
        TAIDEX_W::new(self, 0)
    }
...
#[doc = "Timer3_A2 Expansion Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ta3ex0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ta3ex0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
