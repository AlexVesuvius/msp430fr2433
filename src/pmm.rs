...
#[doc = "PMM Control 1"]
pub mod pmmctl1;
#[doc = "PMMCTL2 register accessor: an alias for `Reg<PMMCTL2_SPEC>`"]
...
pub mod pmmifg;
#[doc = "PMMIE register accessor: an alias for `Reg<PMMIE_SPEC>`"]
