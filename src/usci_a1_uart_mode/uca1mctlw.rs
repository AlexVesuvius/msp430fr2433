...
pub type R = crate::R<UCA1MCTLW_SPEC>;
#[doc = "Register `UCA1MCTLW` writer"]
pub type W = crate::W<UCA1MCTLW_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucos16(&mut self) -> UCOS16_W<UCA1MCTLW_SPEC> {
        UCOS16_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - USCI First Stage Modulation Select 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrf(&mut self) -> UCBRF_W<UCA1MCTLW_SPEC> {
        UCBRF_W::new(self, 4)
    }
    #[doc = "Bit 8 - USCI Second Stage Modulation Select 0"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs0(&mut self) -> UCBRS0_W<UCA1MCTLW_SPEC> {
        UCBRS0_W::new(self, 8)
    }
    #[doc = "Bit 9 - USCI Second Stage Modulation Select 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs1(&mut self) -> UCBRS1_W<UCA1MCTLW_SPEC> {
        UCBRS1_W::new(self, 9)
    }
    #[doc = "Bit 10 - USCI Second Stage Modulation Select 2"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs2(&mut self) -> UCBRS2_W<UCA1MCTLW_SPEC> {
        UCBRS2_W::new(self, 10)
    }
    #[doc = "Bit 11 - USCI Second Stage Modulation Select 3"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs3(&mut self) -> UCBRS3_W<UCA1MCTLW_SPEC> {
        UCBRS3_W::new(self, 11)
    }
    #[doc = "Bit 12 - USCI Second Stage Modulation Select 4"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs4(&mut self) -> UCBRS4_W<UCA1MCTLW_SPEC> {
        UCBRS4_W::new(self, 12)
    }
    #[doc = "Bit 13 - USCI Second Stage Modulation Select 5"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs5(&mut self) -> UCBRS5_W<UCA1MCTLW_SPEC> {
        UCBRS5_W::new(self, 13)
    }
    #[doc = "Bit 14 - USCI Second Stage Modulation Select 6"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs6(&mut self) -> UCBRS6_W<UCA1MCTLW_SPEC> {
        UCBRS6_W::new(self, 14)
    }
    #[doc = "Bit 15 - USCI Second Stage Modulation Select 7"]
    #[inline(always)]
    #[must_use]
    pub fn ucbrs7(&mut self) -> UCBRS7_W<UCA1MCTLW_SPEC> {
