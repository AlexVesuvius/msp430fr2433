...
pub type R = crate::R<CSCTL8_SPEC>;
#[doc = "Register `CSCTL8` writer"]
pub type W = crate::W<CSCTL8_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aclkreqen(&mut self) -> ACLKREQEN_W<CSCTL8_SPEC> {
        ACLKREQEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - MCLK Clock Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn mclkreqen(&mut self) -> MCLKREQEN_W<CSCTL8_SPEC> {
        MCLKREQEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - SMCLK Clock Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn smclkreqen(&mut self) -> SMCLKREQEN_W<CSCTL8_SPEC> {
        SMCLKREQEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - MODOSC Clock Request Enable"]
    #[inline(always)]
    #[must_use]
    pub fn modoscreqen(&mut self) -> MODOSCREQEN_W<CSCTL8_SPEC> {
