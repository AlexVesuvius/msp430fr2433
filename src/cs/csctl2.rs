...
pub type R = crate::R<CSCTL2_SPEC>;
#[doc = "Register `CSCTL2` writer"]
pub type W = crate::W<CSCTL2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flln0(&mut self) -> FLLN0_W<CSCTL2_SPEC> {
        FLLN0_W::new(self, 0)
    }
    #[doc = "Bit 1 - FLL Multipier Bit : 1"]
    #[inline(always)]
    #[must_use]
    pub fn flln1(&mut self) -> FLLN1_W<CSCTL2_SPEC> {
        FLLN1_W::new(self, 1)
    }
    #[doc = "Bit 2 - FLL Multipier Bit : 2"]
    #[inline(always)]
    #[must_use]
    pub fn flln2(&mut self) -> FLLN2_W<CSCTL2_SPEC> {
        FLLN2_W::new(self, 2)
    }
    #[doc = "Bit 3 - FLL Multipier Bit : 3"]
    #[inline(always)]
    #[must_use]
    pub fn flln3(&mut self) -> FLLN3_W<CSCTL2_SPEC> {
        FLLN3_W::new(self, 3)
    }
    #[doc = "Bit 4 - FLL Multipier Bit : 4"]
    #[inline(always)]
    #[must_use]
    pub fn flln4(&mut self) -> FLLN4_W<CSCTL2_SPEC> {
        FLLN4_W::new(self, 4)
    }
    #[doc = "Bit 5 - FLL Multipier Bit : 5"]
    #[inline(always)]
    #[must_use]
    pub fn flln5(&mut self) -> FLLN5_W<CSCTL2_SPEC> {
        FLLN5_W::new(self, 5)
    }
    #[doc = "Bit 6 - FLL Multipier Bit : 6"]
    #[inline(always)]
    #[must_use]
    pub fn flln6(&mut self) -> FLLN6_W<CSCTL2_SPEC> {
        FLLN6_W::new(self, 6)
    }
    #[doc = "Bit 7 - FLL Multipier Bit : 7"]
    #[inline(always)]
    #[must_use]
    pub fn flln7(&mut self) -> FLLN7_W<CSCTL2_SPEC> {
        FLLN7_W::new(self, 7)
    }
    #[doc = "Bit 8 - FLL Multipier Bit : 8"]
    #[inline(always)]
    #[must_use]
    pub fn flln8(&mut self) -> FLLN8_W<CSCTL2_SPEC> {
        FLLN8_W::new(self, 8)
    }
    #[doc = "Bit 9 - FLL Multipier Bit : 9"]
    #[inline(always)]
    #[must_use]
    pub fn flln9(&mut self) -> FLLN9_W<CSCTL2_SPEC> {
        FLLN9_W::new(self, 9)
    }
    #[doc = "Bits 12:14 - Loop Divider Bit : 0"]
    #[inline(always)]
    #[must_use]
    pub fn flld(&mut self) -> FLLD_W<CSCTL2_SPEC> {
        FLLD_W::new(self, 12)
    }
...
#[doc = "CS Control Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`csctl2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`csctl2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
