...
pub type UCBUSY_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1STATW_SPI_SPEC, bool, O>;
...
pub type UCOE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1STATW_SPI_SPEC, bool, O>;
...
pub type UCFE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1STATW_SPI_SPEC, bool, O>;
...
pub type UCLISTEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCA1STATW_SPI_SPEC, bool, O>;
impl R {
